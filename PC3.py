...
with st.sidebar:
    opciones = option_menu("Sobre Mí: ",['Inicio', 'Experiencia', 'Gráficos'] , 
        icons=['bookmark-star','pc-display-horizontal', 'cake'], menu_icon="magic", default_index=0)
    # Crea un menú de opciones dentro de la barra lateral -> option_menu(...)
    # Título que se mostrará encima del menú -> "Sobre Mí: "
    ...
    # Icono principal que aparece junto al título del menú -> menu_icon="magic"
